...
```
![PXK7Ctk](https://github.com/user-attachments/assets/cfab5d27-468e-487c-b10f-cf732dc27656)
...
service ssh restart
```
# 🔐 Add GRUB Password (Optional but Recommended)

Generate a hashed GRUB2 password:
```
grub-mkpasswd-pbkdf2
```
<br>
Copy the long hash output.
<br>
...
# ▶️ Running ubuntu.sh Manually (If Needed)

If using the standalone hardening repo instead of install.sh:
```
git clone https://github.com/konstruktoid/hardening.git
cd hardening
```

Edit configuration (update CHANGEME):
```
nano ubuntu.cfg
```
